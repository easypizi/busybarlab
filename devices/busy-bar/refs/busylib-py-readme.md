...
Open in a browser and you'll get the bar's own web UI, which
...
The page at is the bar's web UI. Its `/docs` page describes
...
| `--only ` | Run one step: `firmware`, `wifi`, `timezone`, `name`, `cloud` |
