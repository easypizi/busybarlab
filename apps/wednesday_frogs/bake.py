...
from apps.common.animfile import decode_check, encode_anim
from apps.common.pixelart import DEFAULT_PALETTE
from apps.wednesday_frogs.animation import hop_offset
from apps.wednesday_frogs.sprites import (
    FLY,
    FROG_HOP,
    FROG_HOP_SAD,
    FROG_LAND,
