...
from apps.cursor_pet.hud import HudController, render_hud
from apps.cursor_pet.sprites import build_pet_png
...
class PetScene:
    ...
    def ensure_sprites(self, backend, state: PetState) -> str:
        ...
        if self._uploaded_key != key:
            ...
            from apps.cursor_pet.sprites import BOWL_P, BOWL_W, FOOD, egg
